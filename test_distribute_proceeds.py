...
class TestDistributeProceedsForKrakatoaVentures(unittest.TestCase):
    def setUp(self):
        self.cap_table = {
            "A": {
                ...
                "unit_holders": [
                    {"name": "David", "units_held": 10, "amount_invested": 0}
                ],
            },
            "B": {
            ...
            "C": {
                ...
                "unit_holders": [
                    {"name": "Becky", "units_held": 5, "amount_invested": 0}
                ],
            },
        }
    ...
    def test_distribute_0_dollars(self):
        ...
        self.assertDictEqual(
            dict(member_distribution), {"Alex": 0, "Becky": 0, "David": 0}
        )
    ...
    def test_distribute_100_dollars(self):
        ...
        self.assertAlmostEqual(class_distribution_total, cash_proceeds, delta=1)
        self.assertDictEqual(
            dict(member_distribution), {"Alex": 5000, "Becky": 5000, "David": 0}
        )
        self.assertAlmostEqual(member_distribution_total, cash_proceeds, delta=1)
    ...
    def test_distribute_250_dollars_and_50_cents(self):
        ...
        self.assertAlmostEqual(class_distribution_total, cash_proceeds, delta=1)
        self.assertDictEqual(
            dict(member_distribution), {"Alex": 12525, "Becky": 12525, "David": 0}
        )
        self.assertAlmostEqual(member_distribution_total, cash_proceeds, delta=1)
    ...
    def test_distribute_500_dollars(self):
        ...
        self.assertAlmostEqual(class_distribution_total, cash_proceeds, delta=1)
        self.assertDictEqual(
            dict(member_distribution), {"Alex": 25000, "Becky": 25000, "David": 0}
        )
        self.assertAlmostEqual(member_distribution_total, cash_proceeds, delta=1)
    ...
    def test_distribute_1000_dollars(self):
        ...
        self.assertDictEqual(
            dict(class_distribution), {"A": 14286, "B": 78572, "C": 7143}
        )
        self.assertAlmostEqual(class_distribution_total, cash_proceeds, delta=1)
        self.assertDictEqual(
            dict(member_distribution), {"Alex": 39286, "Becky": 46429, "David": 14286}
        )
        self.assertAlmostEqual(member_distribution_total, cash_proceeds, delta=1)
